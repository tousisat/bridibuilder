! function(t) {
    ...
    var e = Array.prototype.slice,
        ...
        c = r.height(),
        p = function() {
            for (var e = r.scrollTop(), i = s.height(), n = i - c, p = e > n ? n - e : 0, a = 0, d = o.length; d > a; a++) {
                var l = o[a],
                ...
                if (l.stickyWrapper.css("height", l.stickyElement.outerHeight()), h >= e) null !== l.currentTop && (l.stickyElement.css({
                    ...
                    var g = i - l.stickyElement.outerHeight() - l.topSpacing - l.bottomSpacing - e - p;
                    ...
                    var m = l.stickyWrapper.parent(),
                        f = l.stickyElement.offset().top + l.stickyElement.outerHeight() >= m.offset().top + m.outerHeight() && l.stickyElement.offset().top <= l.topSpacing;
            ...
            init: function(e) {
                ...
                return this.each(function() {
                    ...
                    i.center && p.css({
                        ...
                        "float": "right"
                    }), i.stickyElement = e, i.stickyWrapper = p, i.currentTop = null, o.push(i), d.setWrapperHeight(this), d.setupChangeListeners(this)
                })
            },
